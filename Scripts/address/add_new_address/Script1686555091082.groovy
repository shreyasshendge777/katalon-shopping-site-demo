...
WebUI.setText(findTestObject('Object Repository/Page_Checkout/input_Street Address Line 1_street0'), 'Add1')

WebUI.setText(findTestObject('Object Repository/Page_Checkout/input_Street Address Line 2_street1'), 'Add2')

WebUI.setText(findTestObject('Object Repository/Page_Checkout/input_Street Address Line 3_street2'), 'Add2')
...
WebUI.setText(findTestObject('Object Repository/Page_Checkout/input_ZipPostal Code_postcode'), '24455')

...
WebUI.setText(findTestObject('Object Repository/Page_Account Information/input_First Name_firstname'), Fname)

WebUI.setText(findTestObject('Object Repository/Page_Account Information/input_Last Name_lastname'), Lname)
